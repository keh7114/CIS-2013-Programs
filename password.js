...
var passwordCheckOld = function () 
{
  ...
  for (i=0; i<arrayBadPasswords.length;i++)
      ...
      if (stringPassword.length < 8)
        {
          stringOutput = "Password is too short, please enter a password greater than 8 characters";
        }
        else
        {
          for (var i=0; i<arrayBadPasswords.length;i++)
          {
            ...
            {
                stringOutput = "This is not a good password";
            }
          }
        }
          if (stringOutput==="")
          {
            stringOutput = "This password is good, congrats!";
          }
